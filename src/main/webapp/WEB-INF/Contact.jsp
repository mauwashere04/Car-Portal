...
<div class="topnav" id="myTopnav">
  ...
  <a href="/contactus" style = "float:right;" class="active">Contact Us</a>
...
<div class="input-container ic2">
<input type="text" class="input" placeholder=" " id="Phonenumber"/>
<div class="cut"></div>
<label class="placeholder">Phonenumber</label>
</div>

<div class="input-container ic2">
<input type="text" class="input" placeholder=" " id="Feedback"/>
<div class="cut"></div>
<label class="placeholder">Feedback</label>
</div>
