...
<form action="dataupdate" method="post" class="form" enctype="multipart/form-data">
<div class="title">Update Store</div>
<div class="input-container ic1">
<input type="text" class="input" value="${ant4.carId}" id="carId" name="cId" readonly="readonly"/>
<div class="cut"></div>
<label class="placeholder">Car Id</label>
</div>

<div class="input-container ic2">
<input type="text" class="input" value="${ant4.carRegNumber}" id="carRegNumber" name="cRegNumber"/>
<div class="cut"></div>
<label class="placeholder">Registration Number</label>
</div>

<div class="input-container ic2">
<input type="text" class="input" value="${ant4.carModel}" id="carModel" name="cModel"/>
<div class="cut"></div>
<label class="placeholder">Car Model</label>
</div>

<div class="input-container ic1">
<input type="text" class="input" value="${ant4.carPrice}" id="carPrice" name="cPrice"/>
<div class="cut"></div>
