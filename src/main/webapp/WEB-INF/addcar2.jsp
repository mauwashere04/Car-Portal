...
<div class="topnav" id="myTopnav">
  ...
  <a href="/add2" style = "float:right;" class="active">Add Cars</a>
...
<st:form action="adddata2" method="post" modelAttribute="ant" cssClass="form" enctype="multipart/form-data" >
...
<div class="input-container ic2">
<input type="file" name="fileImage" class="input" placeholder=" " id="carImage" accept="image/png, image/jpeg"/>
<div class="cut"></div>
