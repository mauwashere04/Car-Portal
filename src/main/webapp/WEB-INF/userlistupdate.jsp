...
<form action="listuserupdate" method="post" class="form">
<div class="title">Update Profile</div>
<div class="input-container ic1">
<input type="text" class="input" value="${update.userId}" id="userId" name="userId" readonly="readonly"/>
<div class="cut"></div>
<label class="placeholder">User Id</label>
</div>

<div class="input-container ic2">
<input type="text" class="input" value="${update.userName}" id="userName" name="userName"/>
<div class="cut"></div>
<label class="placeholder">Username</label>
</div>

<div class="input-container ic2">
<input type="text" class="input" value="${update.passWord}" id="passWord" name="passWord"/>
<div class="cut"></div>
<label class="placeholder">Password</label>
</div>

<div class="input-container ic1">
<input type="text" class="input" value="${update.mailid}" id="mailid" name="mailid"/>
<div class="cut"></div>
<label class="placeholder">Email</label>
</div>

<div class="input-container ic1">
<input type="text" class="input" value="${update.role}" id="role" name="cPrice"/>
<div class="cut"></div>
