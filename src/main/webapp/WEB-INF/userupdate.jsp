...
<div class="topnav" id="myTopnav">
    <a href="/upage" ><strong>A</strong><strong>B</strong><strong>C</strong> <strong>C</strong>ars</a>
  <form action="/logout">
  <a href="/logout" style = "float:right;">Logout</a>
  </form>
   <a href="/userprofile" style = "float:right;" class="active">Update Profile</a>
...
<input type="text" class="input" value="${ua.userId}" id="userId" name="userId" readonly="readonly"/>
<div class="cut"></div>
<label class="placeholder">User Id</label>
</div>

<div class="input-container ic2">
<input type="text" class="input" value="${ua.userName}" id="userName" name="userName"/>
<div class="cut"></div>
<label class="placeholder">Username</label>
</div>

<div class="input-container ic2">
<input type="text" class="input" value="${ua.passWord}" id="passWord" name="passWord"/>
<div class="cut"></div>
<label class="placeholder">Password</label>
</div>

<div class="input-container ic1">
<input type="text" class="input" value="${ua.mailid}" id="mailid" name="mailid"/>
<div class="cut"></div>
